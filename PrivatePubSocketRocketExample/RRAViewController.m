...
#define NEW_MESSAGES_CHANNEL @"/messages/public"
...
- (void) fetchPrivatePubConfiguration {  
  NSString *resourceUrl = [NSString stringWithFormat:@"https://highthere-stage.herokuapp.com/api/v1/websockets/configuration.json?channel=%@", NEW_MESSAGES_CHANNEL];
